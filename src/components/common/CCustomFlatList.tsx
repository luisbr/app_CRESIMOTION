...
import {FlatList, View, StyleSheet, FlatListProps, ViewStyle} from 'react-native';
import {useSelector} from 'react-redux';
import {moderateScale} from '../../common/constants';

interface CCustomFlatListProps<T> extends FlatListProps<T> {
  containerStyle?: ViewStyle | ViewStyle[];
  trackColor?: string;
  thumbColor?: string;
}

export default function CCustomFlatList<T>({
  containerStyle,
